...
function preTableCategoria_suporte(){
		 $("#limit").change(function(){
	         $("#pagina").val(1);
	         dataTableCategoria_suporte();
	    });
      ...
      $('.table').on("click",".ordemUp",function(e){ 
          var params = { idcategoria_suporte: $(this).attr("codigo")}
          $.post( 'categoria_suporte_script.php?opx=alteraOrdemCima', params,
                function(data){  
    ...
    $('.table').on("click", ".ordemDown", function(e){  
        var params = {idcategoria_suporte: $(this).attr("codigo")}  
        $.post( 'categoria_suporte_script.php?opx=alteraOrdemBaixo', params,
         function(data){  
            var resultado = new String (data.status);  
            if(resultado.toString() == 'sucesso'){ 
              dataTableCategoria_suporte(); 
...
var myColumnDefs = [
	{key:"idcategoria_suporte", sortable:true, label:"ID", print:true, data:true},
...
function columnCategoria_suporte(){ 
    tr = "";
...
function dataTableCategoria_suporte(){
    limit = $("#limit").val();
    pagina = $("#pagina").val();
          ...
          success:function(data){
                ...
                if(data.totalRecords > 0){
                    ...
                    $.each(myColumnDefs, function(col, ColumnDefs){
                      ...
                      tr += '<a href="index.php?mod=categoria_suporte&acao=formCategoria_suporte&met=editCategoria_suporte&idu='+value.idcategoria_suporte+'"><img src="images/ico_edit.png" height="16" width="16" alt="ico" /><div class="tt"><span class="one">Editar</span><span class="two"></span></div></a>';
                      tr += '<a href="#" onclick="wConfirm(\'Excluir Registro\',\'Tem certeza que deseja excluir o registro '+value.idcategoria_suporte+' ?\',\'php\', \'categoria_suporte_script.php?opx=deletaCategoria_suporte&idu='+value.idcategoria_suporte+'\');"><img src="images/ico_del.png" height="17" width="17" alt="ico" /><div class="tt"><span class="one">Excluir</span><span class="two"></span></div></a>';
                      tr += '</div></td>';
                    }); 
...
$(document).ready(function(){
    $(".cancelar").click(function(event){
        location.href='index.php?mod=categoria_suporte&acao=listarCategoria_suporte';
    });
    ...
    $(".confirm").click(function(){
        excluirImagem('categoria_suporte', tipo, img, thisElem);
