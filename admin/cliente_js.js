...
function preTableCliente(){
		...
		var params = {
			idcliente: $(this).attr("codigo")
		}

		$.post(
			'cliente_script.php?opx=inverteStatus',
			params,
			function (data) {
	...
	var myColumnDefs = [
		{key:"idcliente", sortable:true, label:"ID", print:true, data:true},
		{key:"titulo", sortable:true, label:"Título", print:true, data:true},
        {key:"nome_segmento", sortable:true, label:"Segmento", print:true, data:true},
               ...
               success:function(data){
                      ...
                      if(data.totalRecords > 0){
                           $.each(data.records, function(index, value){
                                ...
                                tr += '<a href="index.php?mod=cliente&acao=formCliente&met=editCliente&idu='+value.idcliente+'"><img src="images/ico_edit.png" height="16" width="16" alt="ico" /><div class="tt"><span class="one">Editar</span><span class="two"></span></div></a>';
                                tr += '<a href="#" onclick="wConfirm(\'Excluir Registro\',\'Tem certeza que deseja excluir o registro '+value.idcliente+' ?\',\'php\', \'cliente_script.php?opx=deletaCliente&idu='+value.idcliente+'\');"><img src="images/ico_del.png" height="17" width="17" alt="ico" /><div class="tt"><span class="one">Excluir</span><span class="two"></span></div></a>';
                                tr += '</div></td>';
                           });
...
$(document).ready(function(){
    ...
    $(".cancelar").click(function(event){
        location.href='index.php?mod=cliente&acao=listarCliente';
    });
    ...
    $(".confirm").click(function(){
        excluirImagem('cliente', tipo, img, thisElem);
