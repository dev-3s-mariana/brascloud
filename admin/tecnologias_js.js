...
function preTableTecnologias(){
		$("#limit").change(function(){
	         $("#pagina").val(1);
	         dataTableTecnologias();
	    });
		...
		var params = {
			idtecnologias: $(this).attr("codigo")
		}

		$.post(
			'tecnologias_script.php?opx=inverteStatus',
			params,
			function (data) {
	...
	var myColumnDefs = [
		{key:"idtecnologias", sortable:true, label:"ID", print:true, data:true},
               ...
               success:function(data){
                      ...
                      if(data.totalRecords > 0){
                           $.each(data.records, function(index, value){
                                ...
                                tr += '<a href="index.php?mod=tecnologias&acao=formTecnologias&met=editTecnologias&idu='+value.idtecnologias+'"><img src="images/ico_edit.png" height="16" width="16" alt="ico" /><div class="tt"><span class="one">Editar</span><span class="two"></span></div></a>';
                                tr += '<a href="#" onclick="wConfirm(\'Excluir Registro\',\'Tem certeza que deseja excluir o registro '+value.idtecnologias+' ?\',\'php\', \'tecnologias_script.php?opx=deletaTecnologias&idu='+value.idtecnologias+'\');"><img src="images/ico_del.png" height="17" width="17" alt="ico" /><div class="tt"><span class="one">Excluir</span><span class="two"></span></div></a>';
                                tr += '</div></td>';
                           });
...
$(document).ready(function(){
    ...
    $(".cancelar").click(function(event){
        location.href='index.php?mod=tecnologias&acao=listarTecnologias';
    });
    ...
    $(".confirm").click(function(){
        excluirImagem('tecnologias', tipo, img, thisElem);
